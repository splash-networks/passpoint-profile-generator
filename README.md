...
Note: when using username/password the password that we need to supply should be base64 encoded. This code doesn't do plaintext to base64 for password.
...
``` python main.py```<br />
### Just Web Server
Both the profile xml file and the RADIUS server ca.cer file will need to be supplied.<br />
Profiles<br />
